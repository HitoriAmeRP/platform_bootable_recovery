...
public:
	...
	static string Exec_With_Output(const string &cmd, const string &args);      // Run a command with arguments & get the output
	static string Exec_With_Output(const string &cmd);                          // Run a command & get the output
