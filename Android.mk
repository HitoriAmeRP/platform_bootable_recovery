...
ifeq ($(TW_BIND_UMOUNT_BEFORE_FORMAT), true)
    LOCAL_CFLAGS += -DTW_BIND_UMOUNT_BEFORE_FORMAT
endif
ifeq ($(TW_USE_SIMPLIFIED_KEY_DIR_CHECK), true)
    LOCAL_CFLAGS += -DTW_USE_SIMPLIFIED_KEY_DIR_CHECK
endif
